          ...
          <div class="card">
            <div class="card-body">
              <div class="card-title">
                <?php
                $cid = $_GET['viewid'];
                $sql = "SELECT * FROM tblappointments WHERE AptNum=$cid";
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                ...
                ?>
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" name="uid" id="uid" value="<?php echo $row['AptDate']; ?>" disabled>
                  </div>

                  <div class="col-md-6">
                    <label class="form-label">Time</label>

                    <input class="form-control" name="uid" id="uid" value="<?php echo $row['AptTime']; ?>" disabled>
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <textarea class="form-control" id="message" name="message" disabled><?php echo $row['Message']; ?></textarea>
                  </div>
              ...
              <div align="center">
                ...
                <a href="appointment-edit.php?editid=<?php echo htmlentities($cid); ?>" class="add-btn">EDIT DETAILS</a>
                <a type="button" class="add-btn" href="users-profile.php" style="width: 100px;">CANCEL</a>
              </div>
            <?php } ?>
            </form>
            </div>
