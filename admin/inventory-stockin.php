    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="inventory-nav" class="nav-content " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="inventory-stockin.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Stock In Log</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class=" table-responsive">
                <div class="table-wrapper">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                      $ret = mysqli_query($con, "SELECT tblstockin.sinID, tblstockin.prodID, tblstockin.Quantity, tblstockin.Description, tblstockin.Date, tblinventory.ProductName from tblstockin join tblinventory on tblstockin.prodID=tblinventory.ID");
