    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="inventory-nav" class="nav-content" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="inventory-stockout.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Stock Out Log</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class=" table-responsive">
                ...
                <tbody>
                     <?php
                     $ret = mysqli_query($con, "SELECT tblstockout.soutID, tblstockout.prodID, tblstockout.Quantity, tblstockout.Description, tblstockout.Date, tblinventory.ProductName from tblstockout join tblinventory on tblstockout.prodID=tblinventory.ID");
