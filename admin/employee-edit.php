...
<body>
  ...
  <main id="main" class="main">
    <?php
    $eid = $_GET['editid'];
    $ret = mysqli_query($con, "select * from tblemployee where EmployeeID='$eid'");
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="employee-view.php?viewid=<?php echo htmlentities($row['EmployeeID']); ?>"> <?php echo $row['FirstName']; ?> <?php echo $row['LastName']; ?></a></li>
