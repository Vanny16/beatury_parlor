...
<?php include('header.php'); ?>
  ...
  <?php
    $vid=$_GET['viewid'];
    $ret=mysqli_query($con,"select * from tblcustomers where CustID =$vid");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="customer.php">Customers</a></li>
          <li class="breadcrumb-item active"><?php  echo $row['FirstName'];?> <?php  echo $row['LastName'];?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg">
          <div class="card">
           ...
           <div align="center">
           <a href="customer-edit.php?editid=<?php echo htmlentities ($row['CustID']);?>" class="add-btn">EDIT USER DETAILS</a> <a href="customer.php" class="add-btn">CANCEL</a></div>
