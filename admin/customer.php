...
if (isset($_POST['submit'])) {
  ...
  $sql1 = "SELECT * FROM tblcustomers WHERE MobileNumber='$contno'";
  ...
  if (mysqli_num_rows($res) > 0) {
    ...
    echo "<script>alert('Sorry! Mobile Number is already taken.');</script>";
      ...
      $query = mysqli_query($con, "insert into tblcustomers(FirstName,LastName, MobileNumber, Email, Password, Address) value('$fname','$lname', '$contno', '$email','$password','$add' )");
      if ($query) {
      ...
      <div class="row">
        <div class="col-lg">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">
              <button data-toggle="modal" data-target="#employeeaddmodal" class="add-btn">ADD CUSTOMER</button>
              </h5>
                    ...
                    <tbody>
                      ...
                      ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <a type=button data-id=<?php echo htmlentities($row['CustID']); ?> id=getUser data-target=#view-modal class=view title=View data-toggle=modal><i class=material-icons>&#xE417;</i></a>
                              <a href="customer-edit.php?editid=<?php echo htmlentities($row['CustID']); ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
