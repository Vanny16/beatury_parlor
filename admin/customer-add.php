    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add New Customer</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" name="add" onsubmit="return checkpass();" enctype="multipart/form-data">
                ...
                <div align="center"><button type="submit" class="add-btn" name="submit" style="width: 100px;">Add</button> <a type="button" href="customer.php" class="add-btn" name="submit">CANCEL</a></div>
